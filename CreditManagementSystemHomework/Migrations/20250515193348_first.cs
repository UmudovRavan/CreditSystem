        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CreditCreateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoansDetail", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoansDetail_Loans_LoanId",
                        column: x => x.LoanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoansItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoansItem_Loans_LoanId",
                        column: x => x.LoanId,
                        principalTable: "Loans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LoansItem_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoansDetail_LoanId",
                table: "LoansDetail",
                column: "LoanId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LoansItem_LoanId",
                table: "LoansItem",
                column: "LoanId");

            migrationBuilder.CreateIndex(
                name: "IX_LoansItem_ProductId",
                table: "LoansItem",
                column: "ProductId");
